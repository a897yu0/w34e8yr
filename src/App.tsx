...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between bg-gray-100 gap-3 p-3">
      <main className="w-full min-w-xs max-w-3xl flex flex-col items-center gap-2">
        <div className="w-full flex flex-col items-center justify-center bg-white p-5 border border-gray-300
 rounded">
          <h1 className="text-4xl font-bold text-black mb-12">W34</h1>
        </div>
        <div className="w-full min-h-40 flex flex-col items-center justify-center bg-white p-5 border border-gray-300
 rounded">
      ...
      <footer className="w-full min-w-xs max-w-3xl bg-white rounded-lg shadow-sm m-0 dark:bg-gray-800">
        <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://w34.com/" className="hover:underline">W34E8YRz</a>. All Rights Reserved.
          </span>
